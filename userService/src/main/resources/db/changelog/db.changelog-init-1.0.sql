...
VALUES (gen_random_uuid(), 'user1@example.com', '$2b$12$8pIbjjuUhPcYSaI8r3WFbO1cQM.s1..y/qIe7tJ1h/NXhkd3gZuIK', 'user1', 'John', 'Doe', '1990-01-01',
        '+1-234-567-8900'),
       (gen_random_uuid(), 'user2@example.com', '$2b$12$/K85RM9r/CLW9eT2BIyV7u6.IfAGTIiuT6XGl7o7Dz9kUmB/9EJyu', 'user2', 'Jane', 'Smith', '1985-05-15',
        '+1-234-567-8901'),
       (gen_random_uuid(), 'user3@example.com', '$2b$12$8uMv1RsBeTXppS.t7HGZoOf..OMW5kkYQ3zefLCLiodwmKezgiCiG', 'user3', 'Alice', 'Johnson', '2000-12-25',
        '+1-234-567-8902');
